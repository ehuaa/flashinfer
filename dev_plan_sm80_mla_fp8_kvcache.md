...
相应传 scale=1.0。speedup = (cast + bf16 kernel) / fused。
两路输出**逐位一致**（max diff = 0）——e4m3→bf16 cast 是精确的，两条路径在完全
相同的 bf16 值上做 attention。

```
batch seq_len heads  kv GB | fused ms |  cast ms bf16krnl | speedup
   16    1024    16   0.01 |   0.0496 |   0.0626   0.0475 |   2.22x
   64    1024    16   0.04 |   0.1555 |   0.2079   0.1419 |   2.25x
   16    4096    16   0.04 |   0.1163 |   0.2079   0.1065 |   2.70x
   64    4096    16   0.15 |   0.5497 |   0.7913   0.4854 |   2.32x
   16   16384    16   0.15 |   0.4815 |   0.7902   0.4255 |   2.52x
   64   16384    16   0.60 |   2.1271 |   3.1202   1.8647 |   2.34x
   16   65536    16   0.60 |   2.1900 |   3.1262   1.9208 |   2.30x
   64   65536    16   2.42 |   8.4368 |  12.4702   7.3765 |   2.35x
   16    1024   128   0.01 |   0.0897 |   0.0625   0.0813 |   1.60x
   64    1024   128   0.04 |   0.2907 |   0.2081   0.2566 |   1.60x
   16    4096   128   0.04 |   0.2319 |   0.2080   0.2081 |   1.79x
   64    4096   128   0.15 |   1.0794 |   0.7918   0.9455 |   1.61x
   16   16384   128   0.15 |   0.8899 |   0.7915   0.7834 |   1.77x
   64   16384   128   0.60 |   4.2284 |   3.1253   3.6981 |   1.61x
   16   65536   128   0.60 |   3.4524 |   3.1218   3.0225 |   1.78x
   64   65536   128   2.42 |  16.8306 |  12.4692  14.7100 |   1.61x
```

**结论：融合 kernel 快 1.6–2.7x**（heads=128 约 1.6–1.8x，heads=16 约 2.2–2.7x），
且省显存 3 倍。
